...
class Rectangle:
    ...
    Methods:
        ...
        __del__(): Destructor.
       bigger_or_equal(rect_1, rect_2): Static method. Returns the bigger
       rectangle.
       square(cls, size=0): Class method that creates and returns a new square.
    """
    ...
    def bigger_or_equal(rect_1, rect_2):
        """
        Determines and returns the rectangle with the greater area among two
        given rectangles.
    ...
    def square(cls, size=0):
        """
        Creates and returns a square-shaped rectangle with equal
        width and height.
